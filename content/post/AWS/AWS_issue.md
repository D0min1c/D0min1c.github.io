...
서버 한 두대가 죽어도 서비스는 유지될 수 있도록 고가용성 구조를 구성하시는게 가장 좋지만 여러 어른들의 사정에 의해 불가능하다면 최소한 모니터링을 걸어두어 서비스의 빠른 Recovery가 중요합니다. 그렇기에 우리는 AWS에서 제공하는 Cloudwatch를 최대한 활용하는 것이 중요합니다. 관련해서 나중에 모니터링관련 내용도 포스팅하도록 하겠습니다.
